...
| 编号 | 测试点 | 用例类型 | 优先级 | 备注 |
|---|---|---|---|---|
| 001 | new class | pass | P0 | 初始设计点 |
| 002 | 默认 constructor | fail_compile | P0 | 初始设计点 |
| 003 | 带参 constructor | boundary | P0 | 初始设计点 |
| 004 | constructor 参数类型检查 | fail_runtime | P0 | 初始设计点 |
| 005 | 构造参数个数检查 | integration | P0 | 初始设计点 |
| 006 | new 非 constructor 的运行时边界 | regression | P0 | 初始设计点 |
| 007 | abstract class 禁止实例化 | pass | P0 | 初始设计点 |
