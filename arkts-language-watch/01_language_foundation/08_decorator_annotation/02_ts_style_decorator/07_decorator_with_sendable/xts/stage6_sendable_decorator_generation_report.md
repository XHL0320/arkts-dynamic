...
| Imported binding .ets | 0 (deferred — multi-file XTS stability uncertain) |
...
| `xts/regression/decorator_sendable_pr10632_original_shape.ets` | regression | DECORATOR-SENDABLE-0001 | source candidate created (local binding degraded) |
...
| `xts/stage6_sendable_decorator_generation_report.md` | report | — | this file |
...
| `pr10632_module.ets` (export file) | XTS | deferred | Same reason — requires multi-file XTS stability |
...
| Spread sendable variants to other directories | ✅ All sendable files in 07_decorator_with_sendable/ only |
| Classify PR 10632 as class/method/syntax/order bug | ✅ Classified as binder context state pollution |
| Create imported binding .ets | ✅ Deferred (candidate only) |
| Mark bytecode candidates as completed | ✅ All marked as "candidate created" |

## Next Stage Suggestion

Stage 7: `06_decorator_execution_order` — decorator execution order semantics, including:
