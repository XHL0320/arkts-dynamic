...
**Status:** candidate created — no real compiler expected output; PR 10632 regression target
...
**Suggested future file:** none (candidate only — not yet generated as .ets source)
