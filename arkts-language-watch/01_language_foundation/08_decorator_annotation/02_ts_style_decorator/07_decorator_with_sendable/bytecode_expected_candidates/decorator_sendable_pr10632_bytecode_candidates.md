...
5. Imported/local binding is correctly resolved — no lost reference in bytecode
...
4. Property decorator lowered call site bytecode is outside class — NOT sendable
...
5. Compare with sendable variant (Candidate 1) — only class body differs
