...
| class constructor without new | ClassDefinitionEvaluation | ClassName() | fail_runtime | 是 | xts/fail_runtime/class_constructor_call_without_new.fail.ts/js | P2 | 全场景补充 |
