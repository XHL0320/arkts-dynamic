...
| JSON.stringify BigInt | SerializeJSONProperty | JSON.stringify({ x: 1n }) | fail_runtime | 是 | xts/fail_runtime/json_structured_clone_symbol_json_bigint.fail.ts/js | P3 | 全场景补充 |
