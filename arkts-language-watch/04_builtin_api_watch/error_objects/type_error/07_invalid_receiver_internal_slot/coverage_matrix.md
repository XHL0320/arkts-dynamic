...
| Map receiver 内部槽缺失 | RequireInternalSlot | Map.prototype.get.call({}) | fail_runtime | 是 | xts/fail_runtime/invalid_receiver_map_get_plain_object.fail.ts/js | P0 | 第一批 P0 示例 |
