...
| @@iterator 返回非 object | GetIterator | Array.from(badIterable) | fail_runtime | 是 | xts/fail_runtime/iterator_protocol_iterator_returns_non_object.fail.ts/js | P0 | 第一批 P0 示例 |
