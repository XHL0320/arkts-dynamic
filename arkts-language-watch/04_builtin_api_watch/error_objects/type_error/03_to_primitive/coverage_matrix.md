...
| Symbol.toPrimitive 返回 object | ToPrimitive | String(obj) | fail_runtime | 是 | xts/fail_runtime/to_primitive_symbol_to_primitive_returns_object.fail.ts/js | P2 | 全场景补充 |
