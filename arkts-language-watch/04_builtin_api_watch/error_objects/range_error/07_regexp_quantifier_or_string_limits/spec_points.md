...
|---|---|---|---|---|---|
| 01 | 正则量词范围差异 | 待确认 | 正则量词范围差异 | P3 | 初始规范点 |
| 02 | 字符串长度过大 | 待确认 | 字符串长度过大 | P3 | 初始规范点 |
| 03 | SyntaxError / RangeError 边界 | 待确认 | SyntaxError / RangeError 边界 | P3 | 初始规范点 |

## ArkTS Boundary

| 场景 | ECMA 行为 | ArkTS 静态语言预期 | ArkTS 动态/运行时预期 | 备注 |
|---|---|---|---|---|
| RegExp or string limit RangeError | 运行时异常或解析失败 | 待确认是否前移为编译期错误 | 待确认 ArkRuntime 行为 | 初始记录 |
