...
|---|---|---|---|---|---|
| 01 | import/export 位置错误 | 待确认 | import/export 位置错误 | P2 | 初始规范点 |
| 02 | duplicate export | 待确认 | duplicate export | P2 | 初始规范点 |
| 03 | 跨文件落点 | 待确认 | 跨文件落点 | P2 | 初始规范点 |

## ArkTS Boundary

| 场景 | ECMA 行为 | ArkTS 静态语言预期 | ArkTS 动态/运行时预期 | 备注 |
|---|---|---|---|---|
| Module parse error | 运行时异常或解析失败 | 待确认是否前移为编译期错误 | 待确认 ArkRuntime 行为 | 初始记录 |
