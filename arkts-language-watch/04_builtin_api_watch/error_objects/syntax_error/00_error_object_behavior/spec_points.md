...
|---|---|---|---|---|---|
| 01 | new SyntaxError() | 待确认 | new SyntaxError() | P0 | 初始规范点 |
| 02 | SyntaxError() | 待确认 | SyntaxError() | P0 | 初始规范点 |
...
|---|---|---|---|---|
| SyntaxError Object Behavior | 运行时异常或解析失败 | 待确认是否前移为编译期错误 | 待确认 ArkRuntime 行为 | 初始记录 |
